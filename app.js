...
alert('Welcome to my Guessing Game... a fun way to get to know a little bit about me!');

console.log('The users name is: ' + user);
var user = prompt('What is your name?');
alert('Hello, ' + user + ', I\'m so glad you decided to play my game!');
...
function question2() {
  ...
  if(answer2 === 'yes' || answer2 === 'y') {
    alert('It\'s true, I DO love solving puzzles!');
    userPoints++;
  } else {
...
function question6() {
  var answer6 = prompt('Okay, let\'s shake it up a bit.. How many movies do I own? Guess any number.  You will have 4  guesses.');
  var moviesIOwn = 104;
  ...
  for(var i = 0; i < question6Guesses; i++) {
    ...
    if(answer6 === moviesIOwn) {
      alert('That\'s it... way to go, you are crushing this!');
      userPoints++;
      alert('You have ' + userPoints + ' points.');
      break;
    } else if(answer6 === isNaN || answer6 === null || answer6 === '') {
...
//Question 7: Prompt user to guess answer from an array of answers.
function question7() {
  var answer7 = prompt('Can you guess 1 of the items on my Bucket List? You will have 6 guesses.').toLowerCase();
  console.log('Question 7 answer is: ' + answer7);
  var bucketList = ['running a marathon', 'living abroad for at least 1 year', 'traveling to most of the continents', 'living downtown for a season'];
  var flag = false;
  ...
  while (flag === false && question7Guesses > 0) {
    ...
    if (flag === true) {
      alert('Wow, you got it... great Job!');
      userPoints++;
    } else {
  ...
  alert('Some of the items that are still on my Bucket List are: ' + bucketList);
  alert('You have ' + userPoints + ' points.');
}
question7();
